...
class employeesystem:
    def __init__(self,root):
        ...
        # Set the window icon
        self.root.iconbitmap(r"F:/ProGramming SK'S World/PythOn/Database/skjan.jpg")
...
# ------------------------------------------Frame 1------------------------------------------------------
        frame1=Frame(self.root,bd=5,relief=RIDGE,bg='green')
        ...
        lbl_hireloc=Label(frame1,text='Hired Location',font=('times new roman',14),fg='black').place(x=0,y=280)
        ...
        lbl_address=Label(frame1,text='Address',font=('times new roman',14),fg='black').place(x=0,y=320)
...
# ---------------------------------------- Frame 2 ----------------------------------------------------
        frame2=Frame(self.root,bd=5,relief=RIDGE,bg='green')
        ...
        self.btn_save=Button(frame2,text='        Save        ',command=self.add,font=('times new roman',14),fg='black',bg='lightcyan')
        self.btn_save.place(x=243,y=170)
        
        btn_clear=Button(frame2,text='        Clear        ',command=self.clear,font=('times new roman',14),
                          fg='black',bg='aqua').place(x=375,y=170)
      
        self.btn_update=Button(frame2,text='              Update             ',command=self.update,font=('times new roman',14),
                          fg='black',bg='lightgreen')
        self.btn_update.place(x=120,y=207)
        
        self.btn_delete=Button(frame2,text='             Delete            ',command=self.delete,font=('times new roman',14),
                          fg='black',bg='crimson')
...
# -------------------------------------------- Frame 3 ---------------------------------------------------
        frame3=Frame(self.root,bd=5,relief=RIDGE , bg='green')
        ...
        cal_frame=Frame(frame3,bd=5,relief=RIDGE, bg='green')
        ...
        btn_n1=Button(cal_frame,text=' 1 ',command=lambda:btn_click(1),font=('times new roman',18),
                          fg='white',bg='green').place(x=2,y=152,width=55,height=50)
        btn_n2=Button(cal_frame,text=' 2 ',command=lambda:btn_click(2),font=('times new roman',18),
                          fg='white',bg='green').place(x=57,y=152,width=55,height=50)
        btn_n3=Button(cal_frame,text=' 3 ',command=lambda:btn_click(3),font=('times new roman',18),
                          fg='white',bg='green').place(x=112,y=152,width=55,height=50)
        btn_nsub=Button(cal_frame,command=lambda:btn_click('-'),text=' - ',font=('times new roman',18),
                          fg='white',bg='green').place(x=167,y=162,width=55,height=55)
        
        btn_0=Button(cal_frame,text=' 0 ',command=lambda:btn_click(0),font=('times new roman',18),
                          fg='white',bg='green').place(x=2,y=202,width=55,height=50)
        btn_point=Button(cal_frame,text=' . ',command=lambda:btn_click('.'),font=('times new roman',18),
                          fg='white',bg='green').place(x=57,y=202,width=55,height=50)
        btn_plus=Button(cal_frame,text=' + ',command=lambda:btn_click('+'),font=('times new roman',18),
                          fg='white',bg='green').place(x=112,y=202,width=55,height=50)
        btn_equal=Button(cal_frame,text=' = ',command=result,font=('times new roman',18),
                          fg='white',bg='green').place(x=167,y=217,width=55,height=55)
        btn_c=Button(cal_frame,text=' C ',command=clear_cal,font=('times new roman',18),
                          fg='white',bg='green').place(x=2,y=252,width=165,height=20)
        

        
        ##########################Salary Frame############################
        self.sample=f'''\tOrganization Name, UoBs\n\tAddress: Skardu,Baltistan
.......................................................................
Employee ID\t\t:  
...
'''     
        sub_frame3=Frame(frame3,bd=5,relief=RIDGE, bg='green')
        ...
        sub_frame4=Frame(sub_frame3,bd=5,relief=RIDGE,bg='green')
    ...
    def search(self):
        try:
            ...
            if row==None:
                ...
                #self.var_emp_code.set()+'.txt'
                file_=open("F:/ProGramming SK'S World/PythOn/Database/receipt"+str(row[23]),'r') # the file should be opened in read mood
                self.txt_salary_receipt.delete('1.0',END)
                for i in file_:
        ...
        if self.var_emp_code.get()=='' or self.netsalary.get()=='':
            ...
            try:
                ...
                if row==None:
                    ...
                    con.commit()
                    con.close()
                    file_=open("F:/ProGramming SK'S World/PythOn/Database/receipt"+str(self.var_emp_code.get())+'.txt','w')
    ...
    def calculate(self):
        if self.month.get()==''or self.salary.get()=='' or self.year.get() =='' or self.totaldays.get()=='':
            ...
            #########receipt########################
            newsample=f'''\tOrganization Name, UoBs\n\tAddress: Skardu,Baltistan
.......................................................................
...
'''     
    ...
    def employeeframe(self):
        ...
        self.root2.title('Employee Payroll Management System | By UoBs Students')
        self.root2.geometry('900x500+60+80')
        title1=Label(self.root2,text='Employee Details',font=('times new roman',20),
        ...
        self.employee_tree.column('designation',width=70)
        self.employee_tree.column('name',width=70)
        self.employee_tree.column('age',width=30)
        self.employee_tree.column('gender',width=70)

        self.employee_tree.column('email',width=70)
